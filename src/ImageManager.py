...
class ImageBackup(Screen):
	...
	def doBackup2(self):
		...
		if self.ROOTDEVTYPE == 'jffs2':
			...
			self.commands.append("echo \"boot emmcflash0.kernel1 \'root=/dev/mmcblk0p3 rw rootwait hd51_4.boxmode=12\'\" > %s/STARTUP" %self.WORKDIR)
			self.commands.append("echo \"boot emmcflash0.kernel1 \'root=/dev/mmcblk0p3 rw rootwait hd51_4.boxmode=12\'\" > %s/STARTUP_1" %self.WORKDIR)
			self.commands.append("echo \"boot emmcflash0.kernel2 \'root=/dev/mmcblk0p5 rw rootwait hd51_4.boxmode=12\'\" > %s/STARTUP_2" %self.WORKDIR)
			self.commands.append("echo \"boot emmcflash0.kernel3 \'root=/dev/mmcblk0p7 rw rootwait hd51_4.boxmode=12\'\" > %s/STARTUP_3" %self.WORKDIR)
			self.commands.append("echo \"boot emmcflash0.kernel4 \'root=/dev/mmcblk0p9 rw rootwait hd51_4.boxmode=12\'\" > %s/STARTUP_4" %self.WORKDIR)
